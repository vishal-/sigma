      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-100 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
            ...
            <Link href="#tutors" className="hover:text-indigo-600 transition-colors">
              For Tutors
            </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-b border-slate-200 px-6 py-5 flex flex-col gap-4 animate-in slide-in-from-top-2 duration-200">
            ...
            <Link href="#tutors" className="text-sm font-medium text-slate-700 hover:text-indigo-600" onClick={() => setMobileMenuOpen(false)}>
              For Tutors
            </Link>
            ...
            <div className="flex flex-col gap-2 pt-1">
              ...
              <Link href="#list-classes" className="text-center text-sm font-semibold text-white bg-indigo-600 py-2.5 rounded-xl shadow-sm" onClick={() => setMobileMenuOpen(false)}>
                List Your Classes
              </Link>
            </div>
          </div>
